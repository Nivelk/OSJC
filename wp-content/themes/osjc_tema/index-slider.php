...
<div id="carousel-example-generic" class="carousel slide <?php echo $slider_setting['slider_options']; ?>"data-ride="carousel" 
	...
	<!-- Indicators -->
		...
		<div class="item active">
		   <img src="<?php echo WEBRITI_TEMPLATE_DIR_URI; ?>/images/slide/slide01.jpg">
		...
		<div class="item">
		   <img src="<?php echo WEBRITI_TEMPLATE_DIR_URI; ?>/images/slide/slide02.jpg">
			<div class="container slide-caption">
		...
		<div class="item">
		  <img src="<?php echo WEBRITI_TEMPLATE_DIR_URI; ?>/images/slide/slide03.jpg">
			<div class="container slide-caption">
        ...
        <div class="item">
		  <img src="<?php echo WEBRITI_TEMPLATE_DIR_URI; ?>/images/slide/slide04.jpg">
			<div class="container slide-caption">
