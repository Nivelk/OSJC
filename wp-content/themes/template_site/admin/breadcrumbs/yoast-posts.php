...
if (!class_exists('YoastPosts')) {
	...
	class YoastPosts {
		...
		function register_widget() {
			...
			wp_register_sidebar_widget( 'yoast_posts', __( 'Yoast - Tweaking Websites','templatic' ), array(&$this, 'widget'), array( 'all_link' => 'http://yoast.com/', 'feed_link' => 'http://yoast.com/feed/', 'edit_link' => 'options.php' ) );
