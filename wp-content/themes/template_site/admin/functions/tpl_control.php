...
function templ_the_content($file,$arg=array())
{
	...
	if($layout=='Página com 3 colunas - Posicionada')
	{
	...
	else if($layout=='Página com 3 colunas - Sidebar à esquerda')
	{
	...
	elseif($layout=='Página com 3 colunas - Sidebar à direita')
	{
	...
	elseif($layout=='Página Completa')
	{	
		templ_middle('content content_full',$file);
	}
	else if($layout=='Página com 2 colunas - Sidebar à direita')
	{
		templ_middle('content left',$file);
		templ_sidebar_right('sidebar right');
	}
	else //if($layout=='Página com 2 colunas - Sidebar à esquerda')
	{
