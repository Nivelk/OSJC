...

{
	...
	if(strtolower(get_option('ptthemes_listing_author'))=='sim' || get_option('ptthemes_listing_author')=='')
...

{
	...
	if(strtolower(get_option('ptthemes_listing_date'))=='sim' || get_option('ptthemes_listing_date')=='')
...

{
	...
	if(strtolower(get_option('ptthemes_listing_comment'))=='sim' || get_option('ptthemes_listing_comment')=='')
...

{
	...
	if(strtolower(get_option('ptthemes_listing_category'))=='sim' || get_option('ptthemes_listing_category')=='')
...

{
	...
	if(strtolower(get_option('ptthemes_listing_tags'))=='sim' || get_option('ptthemes_listing_tags')=='')
...

{
	...
	if(strtolower(get_option('ptthemes_details_author'))=='sim' || get_option('ptthemes_details_author')=='')
...

{
	...
	if(strtolower(get_option('ptthemes_details_date'))=='sim' || get_option('ptthemes_details_date')=='')
...

{
	...
	if(strtolower(get_option('ptthemes_details_comment'))=='sim' || get_option('ptthemes_details_comment')=='')
...

{
	...
	if(strtolower(get_option('ptthemes_details_category'))=='sim' || get_option('ptthemes_details_category')=='')
...

{
	...
	if(strtolower(get_option('ptthemes_details_tags'))=='sim' || get_option('ptthemes_details_tags')=='')
...

{
	...
	if (get_option('ptthemes_pagination') == 'Posts via consulta AJAX')
...

{
	...
	if(strtolower(get_option('ptthemes_use_third_party_data'))=='sim')
...

{
	...
	if(strtolower(get_option('ptthemes_top_home_links'))=='sim' || get_option('ptthemes_top_home_links')=='' )
...

{
	...
	if(strtolower(get_option('ptthemes_facebook_button'))=='sim')
...

{
	...
	if(strtolower(get_option('ptthemes_tweet_button'))=='sim')
...

{
	...
	if(strtolower(get_option('ptthemes_show_blog_title'))=='sim')
...

{
	...
	if (strtolower(get_option( 'ptthemes_breadcrumbs'))=='sim') {  ?>
...

{
...

	{
		...
		if(get_option('ptthemes_postcontent_full')=='Conte�do Completo')
...

{
	...
	if(is_category() && strtolower(get_option( 'ptthemes_tag_archives_noindex' ))=='sim')

	{

		echo '<META NAME="ROBOTS" CONTENT="NOINDEX">';

	}elseif(is_tag() && strtolower(get_option( 'ptthemes_tag_archives_noindex' ))=='sim')

	{

		echo '<META NAME="ROBOTS" CONTENT="NOINDEX">';

	}elseif(is_archive() && strtolower(get_option('ptthemes_category_noindex'))=='sim')
...
if(templ_is_third_party_seo() == false){
...

{
    ...
    <div class="main_nav">
        ...
        <ul>
           ...
           <?php if(strtolower(get_option('ptthemes_main_nav_home_links'))=='sim' || get_option('ptthemes_main_nav_home_links')=='' ){?> <li class="<?php if ( is_home() ) { ?>current_page_item<?php } ?> home" ><a href="<?php echo get_option('home'); ?>/"><?php _e('Home');?></a></li><?php }?>
...

{
	 ...
	 if(strtolower(get_option('ptthemes_top_pages_nav_enable'))!='desativar'){?>
	...
	<?php
...

		{
...

			{
				...
				<li><a href="<?php echo $productlink; ?>" rel="bookmark" title="Link permanente para <?php echo $post_title; ?>"><?php echo $post_title; ?></a></li>
