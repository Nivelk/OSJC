...

{
	...
	echo get_option('ptthemes_scripts_footer');	
...
add_action('wp_head','templ_header_settings');
...

{
	...
	if(apply_filters('templ_additional_css_settings', true))

	{

		@include_once(TT_ADMIN_FOLDER_PATH.'add_style.php');

	}

	

	if(get_option('ptthemes_customcss')=='Ativar')
...
function templ_thumbimage_filter($src,$att='&amp;w=100&amp;h=100&amp;zc=1&amp;q=80')
