	...
	// prints the widget
...

        {
          ...
          <?php
			...
			<h3><?php echo apply_filters('templ_login_widget_myaccount_text_filter',__('My Account','templatic'));?></h3>
			...
			<ul class="xoxo blogroll">
				...
				echo apply_filters('templ_login_widget_dashboardlink_filter','<li><a href="'.$authorlink.'">'.__('Dashboard','templatic').'</a></li>');

				echo apply_filters('templ_login_widget_editprofilelink_filter','<li><a href="'.site_url('/?ptype=profile').'">'.__('Edit Profile','templatic').'</a></li>');

				echo apply_filters('templ_login_widget_changepwlink_filter','<li><a href="'.site_url('/?ptype=profile').'">'.__('Change Password','templatic').'</a></li>');

				echo apply_filters('templ_login_widget_logoutlink_filter','<li><a href="'.wp_logout_url(get_option('siteurl')).'">'.__('Logout','templatic').'</a></li>');
		    ...
		    <form name="loginform" id="loginwidgetform" action="" method="post" >

            <input type="hidden" name="widgetptype" value="login" />

           		<div class="form_row"><label><?php _e('Username','templatic');?>  <span>*</span></label>  <input name="log" id="widget_user_login" type="text" class="textfield" /> <span id="user_loginInfo"></span> </div>

                <div class="form_row"><label><?php _e('Password','templatic');?>  <span>*</span></label>  <input name="pwd" id="widget_user_pass" type="password" class="textfield" /><span id="user_passInfo"></span>  </div>
            ...
            <a href="javascript:void(0);showhide_forgetpw();" class="lw_fpw_lnk"><?php _e('Forgot Password?','templatic');?></a> </p>            
            ...
            <h4><?php _e('Forgot Password','templatic');?> </h4> 
           ...
           <?php _e('Email','templatic');?>: </label>
            ...
            <input type="submit"name="wp-submit"  id="wp-submit" value="<?php _e('Get New Password','templatic');?>" class="b_signin " />
