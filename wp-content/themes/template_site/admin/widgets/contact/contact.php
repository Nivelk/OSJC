...
?>
	...
	<p class="success_msg"><?php echo apply_filters('templ_contact_widget_successmsg_filter',__('Thank you, your Information send successfully.','templatic'));?></p>
...
?>
	...
	<p class="error_msg"><?php echo apply_filters('templ_contact_widget_errormsg_filter',__('Please fill all the fields before submit.','templatic'));?></p>
