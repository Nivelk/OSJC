...
include_once(TT_WIDGET_FOLDER_PATH.'widgets_sidebar.php'); // all register sidebar widget
...
$widget_array['pika_choose_slider'] = 'pika_choose_slider/pika_choose_slider.php';

$widget_array['anything_slider'] = 'anything_slider/anything_slider.php';

$widget_array['anything_listing_slider'] = 'anything_listing_slider/anything_listing_slider.php';

$widget_array['nivo_slider'] = 'nivo_slider/nivo_slider.php';
