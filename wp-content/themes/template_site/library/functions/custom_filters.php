...

{
	...
	if(get_option('ptthemes_page_layout')=='Página Completa')
	...
	}else if(get_option('ptthemes_page_layout')=='Página com 2 colunas - Sidebar à direita' || get_option('ptthemes_page_layout')=='')
	...
	}else if(get_option('ptthemes_page_layout')=='Página com 2 colunas - Sidebar à esquerda')
	...
	}else if(get_option('ptthemes_page_layout')=='Página com 3 colunas - Posicionada')
	...
	}else if(get_option('ptthemes_page_layout')=='Página com 3 colunas - Sidebar à direita')

	{

	}else if(get_option('ptthemes_page_layout')=='Página com 3 colunas - Sidebar à esquerda')
