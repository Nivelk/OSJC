...
<?php $fullimg = get_post_meta($post->ID, 'fullimg', $single = true);	?>
        ...
        <div <?php post_class('post clear'); ?> id="post_<?php the_ID(); ?>">           
            ...
            <div class="post-meta"> 
				...
				<?php if(get_option('ptthemes_listing_author')=='Sim' || get_option('ptthemes_listing_author')==''){?>  
				...
				<?php } ?>
				 ...
				 <?php } ?>
				  ...
				  <?php if(get_option('ptthemes_listing_tags')=='Sim' || get_option('ptthemes_listing_tags')==''){?>
